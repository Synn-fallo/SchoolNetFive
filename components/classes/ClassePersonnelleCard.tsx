...
import { BookOpen, Users, FileText, Trash2, Edit2, Download, Eye, Settings, Info, Building2 } from 'lucide-react-native';
  ...
  return (
    <Card style={styles.card}>
        ...
        <View style={styles.headerRight}>
          ...
          {isRattachee && (
            <View style={styles.rattacheBadge}>
              <Text style={styles.rattacheBadgeText}>Rattachée</Text>
            </View>
          )}
          {onPressSettings && (
      ...
      {classe.etablissement_nom && (
        <View style={styles.etablissementRow}>
          <Building2 size={12} color="#6B7280" />
          <Text style={styles.etablissementText} numberOfLines={1}>
            {classe.etablissement_nom}
          </Text>
        </View>
      )}
      ...
      <View style={styles.actions}>
        {onPressDetails && (
          <TouchableOpacity style={styles.actionButton} onPress={onPressDetails}>
            <Info size={14} color={theme.colors.primary.DEFAULT} />
