...
import { ArrowLeft, Shield, CheckCircle, AlertCircle, FileText, Users, Lock, Heart } from 'lucide-react-native';
import theme from '@/constants/theme';

export default function CharteParentScreen() {
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        <View style={styles.headerIcon}>
          <Heart size={32} color={theme.colors.primary.DEFAULT} />
        </View>
        <Text style={styles.title}>Charte Parent</Text>
        <Text style={styles.subtitle}>SchoolNet – Engagement parental</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionText}>
          En tant que parent sur SchoolNet, vous jouez un rôle clé dans le suivi éducatif de votre enfant.
          Cette charte définit les engagements pour une utilisation bienveillante et responsable de la plateforme.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.cardText}>Je respecte la vie privée de mon enfant et des autres élèves.</Text>
        </View>
        <View style={styles.card}>
          <Heart size={18} color="#10B981" />
          <Text style={styles.cardText}>J’accompagne mon enfant dans l’utilisation des outils numériques.</Text>
        </View>
        <View style={styles.card}>
          <Users size={18} color="#8B5CF6" />
          <Text style={styles.cardText}>Je communique avec bienveillance avec les enseignants.</Text>
        </View>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>📋 Engagements</Text>
        <Text style={styles.articleText}>• Je m’informe régulièrement des notes et absences de mon enfant.</Text>
        <Text style={styles.articleText}>• J’utilise les outils de contrôle parental de façon responsable.</Text>
        <Text style={styles.articleText}>• Je ne partage pas les identifiants de mon enfant.</Text>
        <Text style={styles.articleText}>• Je signale tout comportement inapproprié à l’équipe SchoolNet.</Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.alertCard}>
          ...
          <Text style={styles.alertText}>
            Tout manquement aux règles de la charte peut entraîner une suspension temporaire ou définitive du compte parent.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity onPress={() => Linking.openURL('https://schoolnet.bj/faq')}>
          <Text style={styles.linkText}>Aide aux parents</Text>
        </TouchableOpacity>
      </View>
