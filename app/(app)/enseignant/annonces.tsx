...
export default function EnseignantAnnoncesScreen() {
      ...
      {annonces.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Aucune annonce n'a été publiée pour les classes où vous enseignez.
          </Text>
        </View>
      ) : (
        <>
          ...
          {annoncesClasse.length > 0 && (
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>📚 Annonces de vos classes</Text>
